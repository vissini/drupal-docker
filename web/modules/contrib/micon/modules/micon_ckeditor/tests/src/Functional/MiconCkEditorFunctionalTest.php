...
namespace Drupal\Tests\micon_ckeditor\Functional;
 ...
 */
class MiconCkEditorFunctionalTest extends BrowserTestBase {
  ...
  public function testUninstallation() {
    // Go to uninstallation page an uninstall micon_ckeditor:
    $session = $this->assertSession();
    $page = $this->getSession()->getPage();
    $this->drupalGet('/admin/modules/uninstall');
    $session->statusCodeEquals(200);
    $page->checkField('edit-uninstall-micon-ckeditor');
