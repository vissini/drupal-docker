...
interface MiconIconInterface {
  ...
  /**
   * Check if there are multiple names defined.
   *
   * @return bool
   *   Name and aliases of icon.
   */
  ...
  /**
   * Get properties name definition of IcoMoon icon.
   *
   * @return string
   *   The IcoMoon icon property names.
   *   Includes all selector names, whereas data name is only the first.
   */
  public function getPropertiesName();

  /**
   * Get the unique names of the IcoMoon icon.
   *
   * @return array
   *   The IcoMoon icon names.
   */
  ...
  /**
   * Get the alias name CSS selector values.
   *
   * @return string
   *   The CSS alias values.
   */
